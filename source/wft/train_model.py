...
from wft import Pipeline, StepWiseSelection, Hyperparams_tuner 
    ...
    def __init__(self, 
        ...
        Main Train Class:
            ...
            stepwise_kwargs:
                ...
                kwargs:
                metric(str): to be optimized: "mse", "mae", "tails_sharpe_ratio"
            ...
            kwargs_cv:
                cv_folds: number of fold in cross validation
                eval_metric(str): to be optimized: "mse", "mae", "tails_sharpe_ratio"
